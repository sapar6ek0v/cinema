...
const SerialRecommendation = ({recommendation}) => {
    return (
                        ...
                        recommendation.map(it => {
                            return (
                                <div className='col-sm-6 col-md-4 col-lg-3 text-center'>
                                    <div className="block">
                                        <Link to={`/tv-serials/serials-info/${it.id}`} className='text-decoration-none text-black'>
                                            <img className='film-img'
                                                 src={"https://image.tmdb.org/t/p/w500" + it.poster_path} alt={it.title}/>
                                            <div className='d-flex align-items-center'>
                                                <div className='content-slick-slider-title'>{it.name}</div>
...
export default SerialRecommendation;